  ...
  head: () => ({
    meta: [
      ...
      { title: "Waxelle Candles — Handmade Soy Candles by Mahy" },
      {
        name: "description",
        content:
          "Waxelle by Mahy: handcrafted 100% soy wax candles, coconut husk designs and candle bouquets, poured in small batches in Jordan.",
      },
      { name: "author", content: "Waxelle by Mahy" },
